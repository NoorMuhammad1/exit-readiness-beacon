...
export const moduleConfigurations: ModuleConfig[] = [
  ...
  { name: 'Post-Close Fundraising', path: '/portal/week-4/post-close-fundraising', weekNumber: 4, order: 17, enhancement: 'NEW' },
  { name: 'Exit Planning', path: '/portal/week-4/exit-planning', weekNumber: 4, order: 18, enhancement: 'NEW' }
];
